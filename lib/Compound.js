...
export default class Compound {
  ...
  constructor(xmlDef, provider, createFn) {
    this.language = xmlDef.$language;
    this.kind = xmlDef.$kind;
    this.id = xmlDef.$id;
    this.access = xmlDef.$prot;
    this.name = this.formatName(xmlDef.compoundname);
    ...
    this.codeLineStart = parseInt(xmlDef.location.$bodystart);
    this.codeLineEnd = parseInt((xmlDef.location.$bodyend > xmlDef.location.$bodystart) ?
